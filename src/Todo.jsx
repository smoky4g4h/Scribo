  ...
  return (
    <div style={styles.page}>
      ...
      <div style={{...styles.card, position: 'relative', zIndex: 1}}>
        ...
        <button onClick={()=>{navigate("/")}} className="pointer-events-auto mt-8 px-8 py-3 bg-white text-black font-semibold rounded-full hover:bg-opacity-10 hover:text-white hover:border-white transition-all duration-300 transform hover:scale-105 hover:shadow-lg shadow-md border border-white backdrop-blur-sm">Home</button>
      </div>
